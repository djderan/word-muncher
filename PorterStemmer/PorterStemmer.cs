...
{
    /// <summary>
    /// Code taken from https://tartarus.org/martin/PorterStemmer/csharp4.txt
    /// </summary>
    public static class PorterStemmer
    {
        private static char[] wordArray;       // character array copy of the given string
        private static int stem, end;          // indices to the current end (last letter) of the stem and the word in the array
        ...
        private static void Truncate(int n = 1)
        {
            end -= n;
        }

        // Count the number of CVC sequences:
        private static int ConsonantSequenceCount()
        {
            int m = 0, index = 0;
        ...
        private static bool EndsWithDoubleConsonant()
        {
        ...
        private static bool PrecededByCVC(int index)
        {
        ...
        private static bool ReplaceEnding(string suffix, string s)
        {
        ...
        private static void OverwriteEnding(string s)
        {
